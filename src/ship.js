function Ship() {
	...
	this.move = function(){
	    ...
	    if (this.vel[0] > 0){
	        this.vel[0] -= this.deceleration * Math.cos(radians(90 + this.lastTheta[2]));
	        if (this.vel[0] < 0){
	            this.vel[0] = 0;
	        }
	    }
	    ...
	    if (this.vel[1] > 0){
	        this.vel[1] -= this.deceleration * Math.sin(radians(90 + this.lastTheta[2]));
	        if (this.vel[1] < 0){
	            this.vel[1] = 0;
	        }
	    }
	...
	this.thrust = function(){
	    if (this.thrustOn){
	        ...
	        this.lastTheta = this.theta.slice(0);
	    }
	}
